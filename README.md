...
**Budget Buddy** is an application tailored to help you manage your budget.
...
<details>
  ...
  <ul>
    <li><a href="https://rubyonrails.org/">Ruby on Rails (Views)</a></li>
  </ul>
</details>
...
```sh
  git clone https://github.com/BucurEva87/budget-buddy.git budget-buddy
```
...
named `budget_buddy_development`. You can create this database
...
If you enjoy this project or find it useful, a star would be much appreciated ^\_^

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 🙏 Acknowledgments <a name="acknowledgements"></a>

- design was inspired by [**Gregoire Vella**](https://www.behance.net/gregoirevella)
